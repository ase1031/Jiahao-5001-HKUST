...
original = original[['is_free', 'price','genres', 'categories', 'tags',\
                     'purchase_date',  'release_date', 'total_positive_reviews',\
                     'total_negative_reviews', 'playtime_forever']]
wait_for_predict = wait_for_predict[['is_free', 'price', 'genres', 'categories', 'tags',\
                     'purchase_date',  'release_date', 'total_positive_reviews',\
...
"""
parameters = [{'C':[1,5,10], 'kernel':['linear']},\
               {'C':range(5,100,5),'kernel':['rbf'],'gamma':[i/100.0 for i in range(5,100,5)]}]
